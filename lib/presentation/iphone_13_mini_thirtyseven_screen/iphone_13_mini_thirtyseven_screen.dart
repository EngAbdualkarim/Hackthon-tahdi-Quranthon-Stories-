...
class Iphone13MiniThirtysevenScreen extends StatelessWidget {
  const Iphone13MiniThirtysevenScreen({Key? key})
      : super(
          key: key,
        );
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        ...
        body: InkWell(
          onTap: () {
            Navigator.of(context).pushNamed(AppRoutes.testPageFourScreen);
          },
          child: SizedBox(
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  CustomImageView(
                                    imagePath:
                                        ImageConstant.imgCheckmarkTeal600,
                                    height: 50.adaptSize,
                                    width: 50.adaptSize,
                                  ),
