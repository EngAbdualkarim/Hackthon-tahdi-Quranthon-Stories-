...
class Iphone13MiniThirtythreeScreen extends StatelessWidget {
  const Iphone13MiniThirtythreeScreen({Key? key})
      : super(
          key: key,
        );
        ...
        body: InkWell(
          onTap: () {
            Navigator.of(context)
                .pushNamed(AppRoutes.iphone13MiniThirtysevenScreen);
          },
          child: SizedBox(
