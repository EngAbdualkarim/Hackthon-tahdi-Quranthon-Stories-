import '../iphone_13_mini_thirtyeight_screen/widgets/six_item_widget.dart';
...
class Iphone13MiniThirtyeightScreen extends StatelessWidget {
  Iphone13MiniThirtyeightScreen({Key? key})
      : super(
          key: key,
        );
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        body: InkWell(
          onTap: () {
            Navigator.of(context).pushNamed(AppRoutes.iphone13MiniElevenScreen);
          },
          child: SizedBox(
